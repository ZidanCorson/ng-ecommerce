...
@Component({
  ...
  template: `
    <div class="mx-auto max-w-[1200px] p-6 md:py-6 md:px-0">
      ...
      <div class="flex flex-col md:flex-row gap-8 mb-8">
        <img [src]="product.imageUrl" alt="{{ product.name }}" class="w-full md:w-[500px] h-auto md:h-[550px] object-cover rounded-lg" 
