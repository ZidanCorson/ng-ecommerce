...
@Component({
  ...
  template: `
    <div class="flex justify-center items-center h-[calc(100vh-64px)] py-6">
      ...
      <p class="text-base">Thank you for your purchase. Your order has been placed successfully.</p>
      <p class="text-gray-600">You will receive an email confirmation shortly with your order details.</p>
